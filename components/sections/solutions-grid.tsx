    ...
    <section id="soluções" className="py-24 relative overflow-hidden bg-black/20">
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16 animate-fade-in-up">
          <h2 className="text-3xl md:text-5xl font-black mb-4 uppercase tracking-tighter italic">Nossas Equipes</h2>
        ...
        <div className="space-y-24">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h3 className="text-4xl font-black italic tracking-tighter uppercase">VIVATEL Cloud</h3>
              ...
              <Link href="/servicos/cloud"><Button className="bg-blue-600 hover:bg-blue-500 font-black uppercase tracking-widest text-[10px]">Saiba Mais</Button></Link>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 order-1 md:order-2">
              <h3 className="text-4xl font-black italic tracking-tighter uppercase">VIVATEL Security</h3>
              ...
              <Link href="/servicos/security"><Button className="bg-blue-600 hover:bg-blue-500 font-black uppercase tracking-widest text-[10px]">Saiba Mais</Button></Link>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
               <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 rounded-full px-3 py-1 mb-2">
                  ...
                  <span className="text-[10px] text-blue-400 font-black uppercase tracking-widest">Digital Core</span>
               </div>
              <h3 className="text-4xl font-black italic tracking-tighter uppercase">Conectividade</h3>
              ...
              <Link href="/servicos/conectividade"><Button className="bg-blue-600 hover:bg-blue-500 font-black uppercase tracking-widest text-[10px]">Saiba Mais</Button></Link>
            </div>
            <div className="bg-white/5 border border-white/10 p-1 rounded-2xl overflow-hidden min-h-[300px] md:min-h-[400px]">
