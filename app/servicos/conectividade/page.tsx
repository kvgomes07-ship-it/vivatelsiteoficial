            ...
            <section className="py-24 relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { icon: <Network className="h-10 w-10 text-blue-500" />, title: "Fibra Óptica", description: "Conexões de até 10 Gbps com latência ultra-baixa e estabilidade superior.", speeds: "100 Mbps - 10 Gbps" },
                            { icon: <Antenna className="h-10 w-10 text-sky-500" />, title: "5G Enterprise", description: "Rede 5G privada para empresas com cobertura dedicada e segurança avançada.", speeds: "Até 1 Gbps" },
                            { icon: <Globe className="h-10 w-10 text-blue-500" />, title: "Internet Dedicada", description: "Links dedicados com SLA garantido e banda simétrica para operações críticas.", speeds: "10 Mbps - 1 Gbps" },
                            { icon: <Wifi className="h-10 w-10 text-sky-500" />, title: "SD-WAN", description: "Redes WAN definidas por software para conectar múltiplas localizações.", speeds: "Escalável" },
                            { icon: <Zap className="h-10 w-10 text-blue-500" />, title: "Conectividade Internacional", description: "Acesso aos cabos submarinos Angola Cable para conectividade global.", speeds: "Até 400 Gbps" },
                            { icon: <Network className="h-10 w-10 text-sky-500" />, title: "MPLS", description: "Redes privadas MPLS para conectar filiais com segurança e performance.", speeds: "Personalizado" },
                        ].map((service, index) => (
                            ...
                            <div className="bg-gradient-to-br from-blue-500/20 to-sky-500/20 p-1 rounded-lg">
                                <div className="bg-gray-900 p-8 rounded-lg">
                                    ...
                                    <div className="space-y-6">
                                        {[
                                            { label: "Cabos Submarinos", value: "SACS + MONET", desc: "Conectando Angola, Brasil, EUA e Europa" },
                                            { label: "Capacidade Total", value: "40 Tbps", desc: "Com roadmap para expansão contínua" },
                                            { label: "Latência", value: "< 3ms local", desc: "Ultra-baixa latência em território nacional" },
                                            { label: "Cobertura", value: "Nacional", desc: "Presença em todas as províncias" },
                                        ].map((item, i) => (
            ...
            <section className="py-24 relative overflow-hidden">
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
                        {[
                            { title: "Redundância Garantida", description: "Múltiplos caminhos de rede para zero downtime", stat: "99.99%", label: "Uptime" },
                            { title: "Suporte 24/7", description: "NOC operacional com equipe especializada", stat: "< 15min", label: "Tempo de Resposta" },
                            { title: "Escalabilidade", description: "Aumente ou reduza banda conforme necessário", stat: "Instant", label: "Provisionamento" },
                            { title: "Segurança", description: "DDoS protection e firewall incluídos", stat: "Enterprise", label: "Grade" },
                        ].map((feature, index) => (
            ...
            <section className="py-24 relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-gray-400 max-w-2xl mx-auto">Soluções de conectividade para diferentes setores.</p>
                    </div>
                    <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                        {[
                            { title: "Setor Bancário", features: ["Links dedicados para agências", "Redundância automática", "Segurança de nível financeiro", "Compliance regulatório"] },
                            { title: "Governo e Instituições", features: ["Redes privadas seguras", "Interconexão entre órgãos", "Soberania de dados", "Suporte prioritário"] },
                            { title: "Empresas e Startups", features: ["Planos flexíveis", "Escalabilidade sob demanda", "IPv4 e IPv6", "Portal de autogestão"] },
                        ].map((useCase, index) => (
                            <div key={index} className="animate-fade-in-up h-full" style={{ animationDelay: `${index * 100}ms` }}>
                                <div className="h-full bg-gradient-to-b from-gray-900 to-gray-950 p-[1px] rounded-xl">
