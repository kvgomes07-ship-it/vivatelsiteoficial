...
export function RoboticsHud() {
  return (
    <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
      ...
      {/* Floating Holograms */}
      <div className="absolute left-[2%] top-[25%] w-32 h-32 md:w-56 md:h-56 z-20 hidden md:flex items-center justify-center animate-float-micro">
      ...
      <div className="absolute right-[2%] top-[30%] w-40 h-40 md:w-64 md:h-64 z-20 hidden md:flex items-center justify-center animate-float-micro" style={{ animationDelay: '1s' }}>
        <div className="relative w-full h-full">
