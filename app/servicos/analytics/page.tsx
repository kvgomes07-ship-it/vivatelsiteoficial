...
import { AnalyticsPlatformWrapper as AnalyticsPlatform } from "@/components/interactive/wrappers/analytics-wrapper"
            ...
            <section className="py-24 relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { icon: <Activity className="h-10 w-10 text-blue-500" />, title: "Dashboards em Tempo Real", description: "Visualize métricas e KPIs atualizados em tempo real com dashboards interativos." },
                            { icon: <Brain className="h-10 w-10 text-sky-500" />, title: "Machine Learning Integrado", description: "Análise preditiva com modelos de ML que aprendem com seus dados." },
                            { icon: <TrendingUp className="h-10 w-10 text-blue-500" />, title: "Análise de Tendências", description: "Identifique padrões e tendências para tomar decisões proativas." },
                            { icon: <PieChart className="h-10 w-10 text-sky-500" />, title: "Visualizações Customizáveis", description: "Crie gráficos e visualizações personalizadas para suas necessidades." },
                            { icon: <Database className="h-10 w-10 text-blue-500" />, title: "Integração de Dados", description: "Conecte múltiplas fontes de dados e unifique sua análise." },
                            { icon: <Zap className="h-10 w-10 text-sky-500" />, title: "Alertas Inteligentes", description: "Receba notificações automáticas baseadas em condições personalizadas." },
                        ].map((feature, index) => (
            ...
            <section className="py-24 relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-gray-400 max-w-2xl mx-auto">Soluções de analytics para diferentes setores e necessidades.</p>
                    </div>
                    <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
                        {[
                            { title: "Análise de Performance de Infraestrutura", description: "Monitore a saúde da sua infraestrutura digital em tempo real.", features: ["Monitoramento de servidores e aplicações", "Detecção de anomalias com IA", "Otimização de recursos", "Previsão de capacidade"] },
                            { title: "Business Intelligence", description: "Transforme dados de negócio em insights estratégicos.", features: ["Análise de vendas e receita", "Segmentação de clientes", "Análise de churn e retenção", "Previsões financeiras"] },
                            { title: "Análise de Comportamento de Usuário", description: "Entenda como seus usuários interagem com seus serviços.", features: ["Mapas de calor e jornadas", "Análise de conversão", "Testes A/B automatizados", "Personalização baseada em dados"] },
                            { title: "Análise de Segurança", description: "Detecte ameaças e mantenha sua infraestrutura segura.", features: ["Detecção de intrusões", "Análise de logs de segurança", "Identificação de vulnerabilidades", "Compliance e auditoria"] },
                        ].map((useCase, index) => (
                            <div key={index} className="animate-fade-in-up h-full" style={{ animationDelay: `${index * 100}ms` }}>
                                <div className="h-full bg-gradient-to-b from-gray-900 to-gray-950 p-[1px] rounded-xl">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
                        <div className="space-y-6 animate-fade-in-up">
                            ...
                            <p className="text-gray-300 text-lg">Nossa plataforma de analytics processa bilhões de eventos por dia com baixa latência e alta precisão.</p>
                            <ul className="space-y-4">
                                {["Processamento em tempo real com Apache Kafka", "Armazenamento otimizado com ClickHouse", "Modelos de ML com TensorFlow e PyTorch", "APIs REST e GraphQL para integração", "SDK para Python, JavaScript e Go", "Exportação para CSV, Excel, PDF e JSON", "Webhooks e integrações nativas", "Conformidade GDPR e regulamentações locais"].map((f, i) => (
                            ...
                            <div className="bg-gradient-to-br from-blue-500/20 to-sky-500/20 p-1 rounded-lg">
                                <div className="bg-gray-900 p-8 rounded-lg">
                                    ...
                                    <div className="space-y-6">
                                        {[
                                            { label: "Latência de Consulta", value: "< 100ms", pct: "95%" },
                                            { label: "Taxa de Processamento", value: "1M eventos/seg", pct: "90%" },
                                            { label: "Retenção de Dados", value: "Ilimitada", pct: "100%" },
                                            { label: "Precisão de Previsões", value: "94%+", pct: "94%" },
                                        ].map((spec, i) => (
                                            <div key={i}>
            ...
            <section className="py-24 relative overflow-hidden">
                <div className="container mx-auto px-4 relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-gray-400 max-w-2xl mx-auto">Escolha o plano ideal para o volume de dados da sua empresa.</p>
                    </div>
                    <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                        {[
                            { name: "Starter", price: "AOA 49k", period: "mês", popular: false, features: ["100K eventos/mês", "3 dashboards", "1 ano de retenção", "Alertas básicos", "Suporte por Email"] },
                            { name: "Professional", price: "AOA 199K", period: "mês", popular: true, features: ["1M eventos/mês", "Dashboards ilimitados", "2 anos de retenção", "ML e previsões", "Alertas avançados", "Suporte Priority"] },
                            { name: "Enterprise", price: "Custom", period: "", popular: false, features: ["Eventos ilimitados", "Dashboards ilimitados", "Retenção personalizada", "ML personalizado", "White-label", "Suporte 24/7", "Gerente de Conta"] },
                        ].map((plan, index) => (
                            <div key={index} className="animate-fade-in-up relative" style={{ animationDelay: `${index * 100}ms` }}>
                                {plan.popular && <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-gradient-to-r from-blue-600 to-sky-500 text-white text-sm font-medium px-4 py-1 rounded-full">Mais Popular</div>}
                                <div className={`h-full bg-gradient-to-b from-gray-900 to-gray-950 p-[1px] rounded-xl ${plan.popular ? "ring-2 ring-sky-500/50" : ""}`}>
                                    <div className="h-full bg-gradient-to-b from-gray-900 to-gray-950 p-8 rounded-xl border border-gray-800/50">
                                        ...
                                        <div className="mb-6"><span className="text-4xl font-bold">{plan.price}</span>{plan.period && <span className="text-gray-400">/{plan.period}</span>}</div>
                                        <ul className="space-y-3 mb-8">
                                            {plan.features.map((f, i) => (
                                                <li key={i} className="flex items-center gap-2"><CheckCircle className="h-5 w-5 text-sky-500" /><span className="text-gray-300">{f}</span></li>
                                            ))}
                                        </ul>
            ...
            <section className="py-24 relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-4xl mx-auto text-center animate-fade-in-up">
                        ...
                        <p className="text-gray-400 text-lg mb-8 max-w-2xl mx-auto">Comece a analisar seus dados hoje e descubra insights que podem transformar seu negócio.</p>
