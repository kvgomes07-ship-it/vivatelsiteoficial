...
function HeroCarousel() {
  const slides = [
    ...
    { type: 'image', src: '/close-up-woman-typing-keyboard.jpg', title: "Interface", value: "100", suffix: "%", desc: "Experiência de utilizador fluida e desenhada para alta produtividade digital." },
    { type: 'image', src: '/ai-powered-device-concept.jpg', title: "Inteligência", value: "94", suffix: "%", desc: "Processamento de dados otimizado com modelos de IA soberanos para Angola." },
    { type: 'image', src: '/maoderobo.jpg', title: "Automação", value: "24/7", suffix: "", desc: "Monitorização proativa e automação robótica para sistemas industriais." },
    { type: 'image', src: '/saas-concept-collage.jpg', title: "Ecossistema", value: "Global", suffix: "", desc: "Conectividade transatlântica através dos cabos SACS e MONET." },
  ]
